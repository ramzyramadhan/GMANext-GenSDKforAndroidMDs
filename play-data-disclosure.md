Select platform: [Android](https://developers.google.com/admob/android/next-gen/privacy/play-data-disclosure "View this page for the Android platform docs.") [Unity](https://developers.google.com/admob/unity/privacy/play-data-disclosure "View this page for the Unity platform docs.") [Android (Legacy)](https://developers.google.com/admob/android/privacy/play-data-disclosure "View this page for the Android (Legacy) platform docs.")

<br />

In May 2021, Google Play [announced the new Data safety
section](https://android-developers.googleblog.com/2021/05/new-safety-section-in-google-play-will.html),
...
regards to your usage of the GMA Next-Gen SDK. On this page, you can find
...
If you are using a prior version of the GMA Next-Gen SDK, consider
updating to the latest version to ensure your app's disclosures are accurate.
The GMA Next-Gen SDK will continue to be updated over time. This page
...
types](https://developer.android.com/guide/topics/data/collect-share) to help you
determine which [data
types](https://support.google.com/googleplay/android-developer/answer/10787469#in_play_console&zippy=%2Cdata-types)
and
[purposes](https://support.google.com/googleplay/android-developer/answer/10787469#in_play_console&zippy=%2Cpurposes)
...
The GMA Next-Gen SDK collects and shares the following data types
*automatically* for

advertising, analytics, and fraud prevention purposes.


| Data | By default, the GMA Next-Gen SDK... |
|---|---|
...
All of the user data collected by GMA Next-Gen SDK is encrypted in
...
file](https://support.google.com/googleplay/android-developer/answer/6048248).

Certain other features in the GMA Next-Gen SDK, such as the
...
- [Blog
  post](https://android-developers.googleblog.com/2021/10/launching-data-safety-in-play-console.html) announcing the Data safety form in Google Play Console.
- The Play Console's Data safety form is available on the [App
  content](https://play.google.com/console/developers/app/app-content/summary) page.